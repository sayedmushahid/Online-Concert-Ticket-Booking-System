    ...
    <div class="w-dyn-items"><div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            <div class="w-col w-col-2">
              <div>July 24, 2021</div>
            </div>
            <div class="w-col w-col-5">
              <div class="venue">Atif Aslam Concert at Karachi</div>
            </div>
            <div class="w-col w-col-3">
              <div>Dawood UET, Karachi</div>
            </div>
            <div class="w-col w-col-2">
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Strings Concert at Islamabad</div>
            </div>
            <div class="w-col w-col-3">
              <div>F9 Park, Islamabad</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Leo Twins Concert at NED University</div>
            </div>
            <div class="w-col w-col-3">
              <div>NED, Karachi</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">One Direction Concert at Islamabad</div>
            </div>
            <div class="w-col w-col-3">
              <div>Centorous, Islamabad</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
          ...
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Atif Aslam Concert at Hyderabad</div>
            </div>
            <div class="w-col w-col-3">
              <div>Hyderabad</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Sayed Alhussaini Concert at APS</div>
            </div>
            <div class="w-col w-col-3">
              <div>APS, Parachinar</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Atif Aslam concert at Lahore</div>
            </div>
            <div class="w-col w-col-3">
              <div>Liberty, Lahore</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
        ...
        <div class="tour-date-row w-row">
            <div class="w-col w-col-2">
              <div>November 24, 2020</div>
            </div>
            <div class="w-col w-col-5">
              <div class="venue">Ali Zafar Concert at Lahore</div>
            </div>
            <div class="w-col w-col-3">
              <div>NCA, Lahore</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">QB Concert at Islamabad</div>
            </div>
            <div class="w-col w-col-3">
              <div>LUMS, Islamabad</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Cold Play Concert at IBA</div>
            </div>
            <div class="w-col w-col-3">
              <div>IBA, Karachi</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Noori Concert at Karachi University</div>
            </div>
            <div class="w-col w-col-3">
              <div>Karachi University, Karachi</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
